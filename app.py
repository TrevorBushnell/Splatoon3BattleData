...
# read in the data
battle_df = pd.read_csv('./data/battle-data.csv')
salmonrun_df = pd.read_csv('./data/salmon-run-data.csv')
...
if turf_inked_stage_options == 'General':
    ...
    game_options = st.selectbox(label='Select Game Mode', options=set(battle_df['rule'].to_list()),key='54gh6k3j45l')
